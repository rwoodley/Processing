...
int[] _startColors = new int[6];
int[] _endColors = new int[6];
...
void initializeColors() {
  ...
  _startColors[4] = color(255,0,255);
  _endColors[4] = color(150,0,150);

  _startColors[5] = color(200,0,200);
  _endColors[5] = color(80,0,80);
